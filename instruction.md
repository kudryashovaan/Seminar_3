...
*git checkout <имя ветки, в моем случае main>* - **вернуться к послеенй версии**

*git branch <имя новой ветки>* - **создание новой ветки**

*git branch* - **вывод список созданных веток**

*git branch -d <имя ветки>* - **удаление ветки**

*git checkout <имя ветки>* - **переход на другую ветку**

*git merge <имя ветки>* - **копирование информации из другой ветки**
